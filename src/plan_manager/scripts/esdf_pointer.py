...
pygame.init()
pygame.display.set_caption('esdf_pointer')
...
def main():
    global point_pub,res_pub

    rospy.init_node("pointer_node", anonymous=True)
    point_pub  =  rospy.Publisher("/check_point", Point, queue_size=10)
    res_pub    =  rospy.Publisher("/reshow", Empty, queue_size=10)
